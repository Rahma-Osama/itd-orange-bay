          ...
          Align(
              ...
              child: Padding(
                  ...
                  child:GestureDetector(
                    onTap: ()=>Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>const HomeView())),
                    child: Container(decoration: BoxDecoration(color: AppColors.MAIN_ORANGE,borderRadius: BorderRadius.circular(40)),
